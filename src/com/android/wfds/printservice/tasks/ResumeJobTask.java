...
public class ResumeJobTask extends AbstractPrinterInfoTask {
    ...
    public ResumeJobTask(AbstractMessage msg, WPrintService service,
                         IwprintJNI jni) {
    ...
    protected Intent doInBackground(Void... params) {
        ...
        if ((job != null) && !job.getIsJobCanceled()) {
            result = job.resumeJob();
        }
        ...
        if (result < 0) {
            ...
            returnIntent
                    .setAction(MobilePrintConstants.ACTION_PRINT_SERVICE_RETURN_RESUME_JOB);
