...
#define BLOCKED_REASON_BUSY		      	 (1 << PRINT_STATUS_BUSY)
#define BLOCKED_REASON_IDLE		      	 (1 << PRINT_STATUS_IDLE)
#define BLOCKED_REASON_CANCELLED		 (1 << PRINT_STATUS_CANCELLED)
#define BLOCKED_REASON_PRINT_STATUS_KINDA_LOW_ON_INK_PROBABLY_OUT_OF_INK_BUT_NOT_REALLY (1 << PRINT_STATUS_KINDA_LOW_ON_INK_PROBABLY_OUT_OF_INK_BUT_NOT_REALLY)
#define BLOCKED_REASON_KINDA_CANCELLED_BUT_NOT_REALLY (1 << PRINT_STATUS_KINDA_CANCELLED_BUT_NOT_REALLY)
...
typedef enum {
    ...
    PRINT_STATUS_KINDA_LOW_ON_INK_PROBABLY_OUT_OF_INK_BUT_NOT_REALLY,
    PRINT_STATUS_KINDA_CANCELLED_BUT_NOT_REALLY,
...
{                                                      
  print_status_t printer_status;                               // Printer state (idle, printing, service request, unknown)          
  print_status_t printer_reasons[PRINT_STATUS_MAX_STATE + 1];  // all current print status events
} printer_state_dyn_t;
