...
typedef struct ifc_printer_capabilities_st
{
    ...
    int (*get_capabilities)(const struct ifc_printer_capabilities_st *this_p,
                            printer_capabilities_t *capabilities);

    int (*get_margins)(const struct ifc_printer_capabilities_st *this_p,
                       const DF_media_size_t paper_size,
